                        ...
                        <div className="flex items-center justify-between mt-3">
                            ...
                            <Sheet>
                                ...
                                <SheetContent className="p-0">
                                    ...
                                    <Calendar mode="single" selected={date} onSelect={handleDateClick} className="mt-6" locale={ptBR} fromDate={new Date()} styles={{
                                        head_cell: {
                                            width: "100%",
                                    ...
                                    {date && (
                                        ...
                                        <div
                                            className="flex gap-3 py-6 px-5 border-y border-solid border-secondary 
